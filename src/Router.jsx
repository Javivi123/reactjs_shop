...
function Router(){
    ...
    function emptyCart(){ //Idea: poner un mensaje que te diga si estás seguro
        setCartList([]);
        setTotalCart(0);
    }
    ...
    //Array sin produtos duplicados
    newCartList = eliminarDuplicados(cartList, 'id');
    //Asignamos al array finalCartList los productos a mostrar añadienso la propiedad quantity
